...
package com.solace.samples.jakarta.messaging.features.serdes.jsonschema;
 ...
 *
 * <p>Usage: JsonSchemaDeserializeConsumerToJsonNode &lt;host:port&gt; &lt;message-vpn&gt; &lt;client-username&gt; [password]
 *
...
public class JsonSchemaDeserializeConsumerToJsonNode {
    ...
    private static final String SAMPLE_NAME = JsonSchemaDeserializeConsumerToJsonNode.class.getSimpleName();
    ...
    private void run(String... args) throws Exception {
        ...
        try (Deserializer<JsonNode> deserializer = new JsonSchemaDeserializer<>();
            ...
            //    - See the JsonSchemaDeserializeConsumerToPojo sample for more details.
            JsonNode jsonNode = deserializer.deserialize(TOPIC_NAME, payloadBytes, headers);

            System.out.println("Received JSON schema message: " + jsonNode);
    ...
    public static void main(String... args) throws Exception {
        ...
        new JsonSchemaDeserializeConsumerToJsonNode().run(args);
    }
}
