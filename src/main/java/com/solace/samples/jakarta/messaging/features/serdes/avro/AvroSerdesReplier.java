...
package com.solace.samples.jakarta.messaging.features.serdes.avro;
 ...
 * {@link AvroSerdesRequestor} sample.
 *
 ...
 *
 * <p>Usage: AvroSerdesReplier &lt;host:port&gt; &lt;message-vpn&gt; &lt;client-username&gt; [password]
 *
...
public class AvroSerdesReplier {
    ...
    private static final String SAMPLE_NAME = AvroSerdesReplier.class.getSimpleName();
    ...
    private void run(String... args) throws Exception {
        ...
        // Create and configure the Avro deserializer (for requests) and serializer (for replies)
            ...
            requestConsumer.setMessageListener(new MessageListener() {
                ...
                public void onMessage(Message request) {
                    try {
                        ...
                        GenericRecord createUserRequest =
                        ...
                        GenericRecord createUserResponse = initEmptyResponseRecord();
                        String userId = UUID.randomUUID().toString().substring(0, 8);
                        createUserResponse.put("id", userId);

                        // Serialize the response using the Avro serializer. The subject is a fixed logical
    ...
    private static GenericRecord initEmptyResponseRecord() throws IOException {
        try (InputStream rawSchema = AvroSerdesReplier.class.getResourceAsStream("/avro-schema/create-user-response.avsc")) {
    ...
    public static void main(String... args) throws Exception {
        ...
        new AvroSerdesReplier().run(args);
    }
}
