...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/SolaceSamples/solace-samples-jms-jakarta/issues).

* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/SolaceSamples/solace-samples-jms-jakarta/issues/new). Be sure to include a **title and clear description**, as much relevant information as possible, and a **code sample** or an **executable test case** demonstrating the expected behavior that is not occurring.
...
* Search [GitHub](https://github.com/SolaceSamples/solace-samples-jms-jakarta/pulls) for an open or closed Pull Request
...
Fork the project [on GitHub](https://github.com/SolaceSamples/solace-samples-jms-jakarta) and clone your fork
locally.

```sh
git clone https://github.com/<my-github-repo>/solace-samples-jms-jakarta
```
...
```sh
$ git remote add upstream https://github.com/SolaceSamples/solace-samples-jms-jakarta
```
...
In GitHub, send a pull request to `solace-samples-jms-jakarta:master`.
...
* Open a GitHub [enhancement request issue](https://github.com/SolaceSamples/solace-samples-jms-jakarta/issues/new) and describe the new functionality.

## <a name="addFeature"></a> **Steps to add a new feature**

* Add your feature source file under src/main/java/com/solace/samples/jakarta/messaging/features/NewFeature.java
* Update the build.gradle file by appending your source file name to the list of scripts  
        ...
        def scripts = [ 'topicPublisher':'com.solace.samples.jakarta.messaging.TopicPublisher',  
                        ...
                        'newFeature':'com.solace.samples.jakarta.messaging.features.NewFeature' ]  
